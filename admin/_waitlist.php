...
<div class="col-md-12">
<input type=button id="check_all" value="Check All" name="check_all">
<div class="table-responsive" style="position: relative; overflow: scroll; width: 100%;">
 <div id="example" class="container container-fixed-lg" >
    ...
    <thead>
        ...
        <input type=submit class="btn btn-success" value=Accept name=accept id=accept>
        <input type=submit class="btn btn-danger" value=Reject name=reject id=reject>
