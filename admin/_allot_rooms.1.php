...
<div class="row">
    <h5> Allot Rooms</h5>
    <form method=post name="myFormapp" id="myFormapp" class="myFormapp" method=post action="_disp_requests.php">

<?php
$name= "SELECT * from application";
                                    ...
                                    {
                                        ?><input type=radio value="<?php echo $row2['id']; ?>" id="<?php echo $row2['id']; ?>" name="application"><?=$row2['name'];?><?php
                                    }
...
?>
 <div class="col-md-12">
                                  <div class="form-group">
                                      <input type="submit" id="submit_formapp" name="submit_formapp" class="btn btn-info btn-fill " style="background: #00A0B0!important;" ></div>
                                  </div>
                                 </div>
</form>
