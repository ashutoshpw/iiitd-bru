                                        ...
                                        <div class="row">
                                            <div class="col-md-5 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="sem"  placeholder="Semester">
                                                </div>
                                            ...
                                            <div class="col-md-5 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="distance"  placeholder="In kms.">
                                                </div>
                                            ...
                                            <div class="col-md-5 pr-1">
                                                ...
                                                <br>
                                                    ...
                                                    <select>
                                                      ...
                                                      <option value="married">PhD. Married</option>
                                                    </select>
