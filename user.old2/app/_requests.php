                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    ...
                                    <?php
                                    $sql = "SELECT application_id, distance, status FROM request_table";
                                    $name= "SELECT name, roll_number, batch, semester, program, address, room_type FROM student_profile, request_table WHERE student_profile.id=request_table.user_id";
                                        	
                                    $received_requests_result1 = mysqli_query($conn,$sql);
                                    $received_requests_result2= mysqli_query($conn,$name);
                                    $received_requests_row_count=mysqli_num_rows($received_requests_result1);
                                       if($received_requests_row_count>0)
                                       {
                                		while ($row1 = mysqli_fetch_assoc($received_requests_result1) and $row2 = mysqli_fetch_assoc($received_requests_result2))
                                		{
