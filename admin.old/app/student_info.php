                            ...
                            <div class="card strpied-tabled-with-hover">
                                ...
                                <div class="card-body table-full-width table-responsive">
 									...
 									<table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                             <?php
                                    $name= "SELECT student_profile.user_id,name,program,room_type,room_number,distance, hostel FROM alloted_students, student_profile WHERE student_profile.user_id=alloted_students.user_id";
