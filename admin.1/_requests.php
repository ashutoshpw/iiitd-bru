...
<div class="table-responsive" style="position: relative; overflow: auto; width: 100%;">
 <div class="container container-fixed-lg" >
    ...
    <thead>
                                    ...
                                    $name= "SELECT student_profile.user_id,application_id,student_profile.distance,status,name,roll_no, batch, semester, program, pincode, room_type_1, room_type_2, hostel_type_1,hostel_type_2 FROM student_profile, request_table WHERE student_profile.id=request_table.user_id and request_table.status='Pending'";
